...
CREATE TABLE CLASE (
    ...
    CLASE_MULTIPLICADOR_RESISTENCIA DOUBLE
);
...
INSERT INTO CLASE (CLASE_NOMBRE, CLASE_DESCRIPCION, CLASE_MULTIPLICADOR_RESISTENCIA) VALUES
...
#CALCULO DAÑO DE EFECTO COMPUESTO
...
#CALCULO DAÑO TOTAL DE UN ARMA
SELECT ARMA_NOMBRE, (EFECTO_DANIO + TIPO_DANIO) * ESTADO_MULTIPLICADOR_DANIO AS DANIO_TOTAL FROM ARMA
JOIN EFECTO E1 ON E1.EFECTO_ID = ARMA_EFECTO
JOIN TIPO T1 ON T1.TIPO_ID = ARMA_TIPO
JOIN ESTADO S1 ON S1.ESTADO_ID = ARMA_ESTADO;

#VER ENEMIGOS Y SUS JEFES
SELECT JEFE.ENEMIGO_NOMBRE, ENEMIGO.ENEMIGO_NOMBRE FROM ENEMIGO ENEMIGO
JOIN ENEMIGO JEFE ON JEFE.ENEMIGO_ID = ENEMIGO.ENEMIGO_JEFE;

#VER MISIONES, MIEMBROS Y PERSONAJES
SELECT * FROM MISION
JOIN MIEMBRO ON MIEMBRO_MISION = MISION_ID
JOIN PERSONAJE ON MIEMBRO_PERSONAJE = PERSONAJE_ID;
